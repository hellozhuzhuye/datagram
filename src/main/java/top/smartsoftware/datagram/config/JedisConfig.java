...
public class JedisConfig {
    private static org.slf4j.Logger log = LoggerFactory.getLogger(JedisConfig.class);
    /**
  ...
  /*  @Value("${spring.redis.pool.max-wait}")
    ...
    /*    jedisPoolConfig.setMaxWaitMillis(maxWaitMillis);*/
        ...
        JedisPool jedisPool = new JedisPool(jedisPoolConfig,host,port,timeout, isEmpty(password)?null:password);
