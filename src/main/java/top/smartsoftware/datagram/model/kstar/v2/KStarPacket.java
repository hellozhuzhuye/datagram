...
public class KStarPacket {
	...
	public void setMsgBodyBytesRegion(byte[] msgBodyBytesRegion) {
		...
		this.lengthRegion = this.msgBodyBytesRegion.length + 14;
