                ...
                i -> {
                    ...
                    switch (s) {
                        ...
                        case "0x0B07":
                            ...
                            break;
                        case "0x0B08":
                            realTimeDataUnit.setChargePower(((float) streamReader.readInt32()) / 1000);
                            break;
                        case "0x0B09":
                ...
                i -> {
                    ...
                    switch (s) {
                        ...
                        case "0x010A":
                            ...
                            break;
                        case "0x010B":
                            historyDataUnit.setChargePower(((float) streamReader.readUInt32()) / 1000);
                            break;
                        case "0x010C":
                            historyDataUnit.setChargeStartPower(((float) streamReader.readUInt32()) / 1000);
                            break;
                        case "0x010D":
                            historyDataUnit.setChargeEndPower(((float) streamReader.readUInt32()) / 1000);
                            break;
                        case "0x010E":
                ...
                i -> {
                    ...
                    switch (flag) {
                        ...
                        case 0x0028:
                            ...
                            break;
                        case 0x0029:
                            rateDataUnit.setServerFee(streamReader.readInt32());
                            break;
                    }
                }
        );
