 ...
 * @version: V1.0
 */
public class ShCmd502 extends AbstractBaseCommand {
    ...
    public class ReqMsg implements Serializable {
		 ...
		 * plate:TODO(分时度数).
		 */
		private int[] multi_charge_degrees;

		public int[] getMulti_charge_degrees() {
			return multi_charge_degrees;
		}

		public void setMulti_charge_degrees(int[] multi_charge_degrees) {
...
//	    	private short Time_48_power;
		...
		public ReqMsg(byte[] bytes) {
			...
			int[] elecquantities = new int[48];
			for(int i=0; i<elecquantities.length; i++){
				elecquantities[i] =  reader.readInt32();
			}
