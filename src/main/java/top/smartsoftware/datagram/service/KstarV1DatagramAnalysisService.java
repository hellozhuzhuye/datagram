...
import top.smartsoftware.datagram.model.kstar.v1.KStarCmd14;
import top.smartsoftware.datagram.model.kstar.v1.KStarCmd6;
import top.smartsoftware.datagram.model.kstar.v1.KStarPacket;
...
@Service
public class KstarV1DatagramAnalysisService implements BaseDatagramAnalysisService {

    @PostConstruct
    public void init() {
        DatagramAnalysisFactory.register(ConstUtil.PROTOCOL.KSTAR_V1.getProtocolCode(), this);
    }
